...
fig3 = px.scatter_mapbox(total_element('Sorghum','production'), lat='Lat',lon='Lon',color='Total',hover_name='Area',size = 'Total',
                        ...
                        zoom=1.7, width=1900, height=700, template='presentation',center=None, mapbox_style='light',title='Global Sorghum Production in Tonnes(2014-2018)')
...
layout = html.Div([
    dbc.Container([
        dbc.Row([
                dbc.Col(html.H1('World Sorghum Statistics at a Glance', className='text-center'), className='mb-4 mt-5')
            ]),
        dbc.Row(
            dbc.Col(html.Div([
