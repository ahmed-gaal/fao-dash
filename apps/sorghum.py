...
fig.add_trace(go.Indicator(
    ...
    delta={'reference': ar[ar['Item'] == 'Sorghum'].Y2017.sum(),
            'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta={'reference': pdd[pdd['Item'] == 'Sorghum'].Y2017.sum(),
            'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta={'reference': yy[yy['Item'] == 'Sorghum'].Y2017.sum()/10000,
            'relative': True},
...
def bar_graph(x=None, y=None, xTitle=None, yTitle=None, title=None, how=None,
              colors=None):
    df = country_info('Somalia', item='Sorghum')
...
fig1 = bar_graph(x='Years', y='Area harvested', xTitle='Area harvested', yTitle='Years',
                 title='Area Harvested (Hectares)', how='h', colors='#920D0D')

fig2 = line_graph(x='Years', y='Production', xTitle='Years', yTitle='Tonnes',
                  colors='#225E54',how='spline', mode='lines',
                  title='Banana Production in Somalia from 2014 - 2018')

fig3 = px.scatter_mapbox(total_element('production', 'Sorghum'), lat='Lat',
