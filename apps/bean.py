...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': ar[ar['Item'] == 'Beans, dry'].Y2017.sum(), 'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': pdd[pdd['Item'] == 'Beans, dry'].Y2017.sum(), 'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': yy[yy['Item'] == 'Beans'].Y2017.sum()/10000, 'relative': True},
    domain = {'x': [0.5, 0], 'y': [1, 0.5]}))

fig1 = country_info('Somalia', item='Beans, dry').iplot(asFigure = True, kind = 'bar', barmode = 'overlay', x = 'Years', y = 'Area harvested',
                                              yTitle = 'Years', xTitle = 'Area Harvested (Hectares)', theme = 'polar', colorscale = 'prgn', orientation = 'h')

fig2 = country_info('Somalia', item='Beans, dry').iplot(asFigure = True, kind = 'bar', barmode = 'overlay', x = 'Years', y = 'Production',
                                              xTitle = 'Years', yTitle = 'Tonnes', theme = 'polar',subplots = True,subplot_titles = True,colors = '#AD1A31', title = 'Beans Production in Somalia from 2014 - 2018')

fig3 = px.scatter_mapbox(total_element('production','Beans, dry'), lat='Lat',lon='Lon',color='Total',hover_name='Area',size = 'Total',
...
fig6 = country_info('Somalia', item='Beans, dry').iplot(asFigure = True, kind = 'barh', x = 'Years', y = 'Area harvested', yTitle = 'Years', subplots = True,subplot_titles = True,xTitle = 'in Hectares', title = 'Area Harvested in Somalia', theme = 'polar', colorscale = 'piyg')
