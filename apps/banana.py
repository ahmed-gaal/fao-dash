...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': ar[ar['Item'] == 'Bananas'].Y2017.sum(), 'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': pdd[pdd['Item'] == 'Bananas'].Y2017.sum(), 'relative': True},
...
fig.add_trace(go.Indicator(
    ...
    delta = {'reference': yy[yy['Item'] == 'Bananas'].Y2017.sum()/10000, 'relative': True},
