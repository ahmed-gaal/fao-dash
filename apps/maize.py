...
def bar_graph(x=None, y=None, xTitle=None, yTitle=None, title=None, how=None,
              colors=None):
    df = country_info('Somalia', item='Maize')
...
fig1 = bar_graph(x='Years', y='Area harvested', xTitle='Area harvested', yTitle='Years',
                 title='Area Harvested (Hectares)', how='h', colors='#3A6EB8')

fig2 = line_graph(x='Years', y='Production', xTitle='Years', yTitle='Tonnes',
                  colors='red',how='spline', mode='lines',
                  title='Maize Production in Somalia from 2014 - 2018')

fig3 = px.scatter_mapbox(total_element('production', 'Maize'), lat='Lat',
