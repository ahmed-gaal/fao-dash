...
fig.add_trace(go.Indicator(
    ...
    delta = {
        'reference': ar[ar['Item'] == 'Cassava'].Y2017.sum(),\
            'relative': True
    },
...
fig.add_trace(go.Indicator(
    ...
    delta = {
        'reference': pdd[pdd['Item'] == 'Cassava'].Y2017.sum(),\
            'relative': True
    },
...
fig.add_trace(go.Indicator(
    ...
    delta = {
        'reference': yy[yy['Item'] == 'Cassava'].Y2017.sum()/10000,\
            'relative': True
    },
...
def bar_graph(x=None, y=None, xTitle=None, yTitle=None, title=None, how=None,
              colors=None):
    df = country_info('Somalia', item='Cassava')
...
fig1 = bar_graph(x='Years', y='Area harvested', xTitle='Area harvested', yTitle='Years',
                 title='Area Harvested (Hectares)', how='h', colors='#904949')

fig2 = line_graph(x='Years', y='Production', xTitle='Years', yTitle='Tonnes',
                  colors='#212521',how='spline', mode='lines',
                  title='Cassava Production in Somalia from 2014 - 2018')

fig3 = px.scatter_mapbox(total_element('production', 'Cassava'), lat='Lat',
                         ...
                         title='Global Cassava Production in Tonnes(2014-2018)')
...
fig4 = data[data['Element'] == 'Production'].iplot(asFigure=True, kind='pie',
                                                   ...
                                                   title='Cassava Production in Africa as at 2018')

fig5 = line_graph(x='Years', y='Yield', xTitle='Years', yTitle='Tonne per hectare',
                  title='Cassava Yield for Somalia (2014 - 2018)', mode='lines+markers',
